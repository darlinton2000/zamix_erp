...
@section('body')
    <div class="login-box">
        <div class="login-logo">
            <a style="color: orange;" href="{{ url(config('adminlte.dashboard_url', 'home')) }}">{!! config('adminlte.logo', '<b>Admin</b>LTE') !!}</a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            ...
            <br>
            <p>
                <a style="color: black;" href="{{ url(config('adminlte.password_reset_url', 'password/reset')) }}" class="text-center">
                    {{ trans('adminlte::adminlte.i_forgot_my_password') }}
                </a>
            </p>
            @if (config('adminlte.register_url', 'register'))
                <p>
                    <a style="color: black;" href="{{ url(config('adminlte.register_url', 'register')) }}" class="text-center">
